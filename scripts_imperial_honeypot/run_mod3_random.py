...
## Define a NCBC topic model object with K=50 session-level topics and H=50 command-level topics
...
## Save results
with open(results_path + 'icl_res_mod3_chain_random_init.pkl', 'wb') as f:
        pickle.dump(ll, f)
        
with open(results_path + 'icl_res_mod3_model_random_init.pkl', 'wb') as f:
        pickle.dump(m, f)